...
<div class="container">
	...
	<div class="left-sidebar" id="left-sidebar" >
		<div class="imp-links">
			<a href="righSideBar/placement/placement.php"><img src="image/news.png" alt="">Placement Cell</a>
	...
	?>
		 ...
		 <div class="add-post-links">
			...
			<form action="php/files.php" method="post" enctype="multipart/form-data">
				<div>
					<textarea name="content" id="editor" placeholder="ask your question ??"></textarea>
